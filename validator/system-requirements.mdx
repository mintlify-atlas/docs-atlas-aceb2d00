...
description: Hardware, software, and SOL requirements for running an Agave validator on Solana.
---
...
### Community Hardware List

A community maintained list of currently optimal hardware can be found at [solanahcl.org](https://solanahcl.org/). It is updated automatically from the [solanahcl/solanahcl Github repo](https://github.com/solanahcl/solanahcl).
...
See the [Installing Solana CLI](/cli/installation) documentation for the current Solana CLI software release.
